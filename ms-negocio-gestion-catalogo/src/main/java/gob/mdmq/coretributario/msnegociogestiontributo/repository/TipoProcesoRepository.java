...
@Repository
public interface TipoProcesoRepository extends JpaRepository<TipoProcesoEntity, Long>{

	
	//JPQL
	  
	  @Query("Select r from TipoProceso r where r.tipoProcesoId = 1 ")
		List<TipoProcesoEntity> findAllCustom();
