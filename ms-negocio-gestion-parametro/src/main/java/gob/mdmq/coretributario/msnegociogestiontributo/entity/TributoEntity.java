 ...
 * @Entity(name = "Tributo")
 * 
 * @Table(name = "COR_TRIBUTO", catalog = "MDMQ_CORE_TRIBUTARIO", schema =
 * "CORE") public class TributoEntity implements Serializable{
 * 
 ...
 * 
 * @Column(name = "TRIBUTO_ID") private Long tributoId;
 * 
 * @Column(name = "CLASE_TRIBUTO_ID") private Long claseTributoId;
 * 
 * @Column(name = "DESCRIPCION_TRIBUTO") private String descripcionTributo;
 * 
 * @Column(name = "DECLARATIVO") private String declarativo; }
 */