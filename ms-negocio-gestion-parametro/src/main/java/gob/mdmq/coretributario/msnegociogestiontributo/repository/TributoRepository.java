...
//
//@Repository
//public interface TributoRepository extends JpaRepository<TributoEntity, Long>{
//
//	
//	//JPQL
//	  
//	  @Query("Select r from Tributo r where r.tributoId = 1 ")
//		List<TributoEntity> findAllCustom();
//	  
//		/*
